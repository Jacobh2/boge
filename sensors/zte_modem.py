...
class ZTEModem:
    ...
    def auth(self) -> dict[str, str]:
        ...
        """
        logger.info("Authenticating towards %s", self.command_set_ip)
    ...
    def list_sms(self) -> list[dict]:
        ...
        logger.info("Lising sms using url %s", url)
    ...
    def delete_sms(self, sms: dict):
        ...
        logger.info("Deleting sms using url %s", self.command_set_ip)
